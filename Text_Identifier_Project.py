...
def run_tests():
    """ compares four pieces of text to John Green and Shakespeare """
    ...
    new2.add_file('the_running_man.txt')
    new2.classify(source1, source2)

    new3 = TextModel('WR100 Paper')
    new3.add_file('wr100.txt')
    new3.classify(source1, source2)

    new4 = TextModel('Hunger Games')
    new4.add_file('hunger_games.txt')
